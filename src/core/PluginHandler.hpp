...
namespace rayTracer {
    class PluginHandler {
        public:
            ...
            const std::map<std::string, rayTracer::PluginHandler::Plugin<ITransformation<double>>> &getTransformationPlugins() const;
        ...
        private:
            ...
            std::map<std::string, rayTracer::PluginHandler::Plugin<ITransformation<double>>> _transformationPlugins;
    };
};
